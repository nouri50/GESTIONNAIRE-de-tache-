describe('Modif password not identical', () => {
  ...
  it('I fill the fields', () => {
    ...
    cy.xpath('//input[@data-cy="new-password-input"]').type('testTest099@')
    cy.xpath('//input[@data-cy="confirm-password-input"]').type('testTest098@')
